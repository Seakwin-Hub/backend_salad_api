...
CREATE TABLE "tbdiseases" (
  ...
  PRIMARY KEY ("did")
)  SERIAL=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE "tbimage" (
  "imageid" int NOT NULL SERIAL,
  "imagename" varchar(100) DEFAULT NULL,
  "typeimg" varchar(100) DEFAULT NULL,
  "imgpath" varchar(500) DEFAULT NULL,
  "other" varchar(100) DEFAULT NULL,
  PRIMARY KEY ("imageid")
)  SERIAL=81 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE "tbsaladtype" (
  "sid" int NOT NULL SERIAL,
  "saladname" varchar(100) DEFAULT NULL,
  "descrip" varchar(1000) DEFAULT NULL,
  PRIMARY KEY ("sid")
)  SERIAL=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-09-14  0:10:48
